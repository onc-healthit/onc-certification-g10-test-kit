...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'inferno_core', '>= 0.3.10'
  ...
  spec.add_runtime_dependency 'smart_app_launch_test_kit', '0.1.5'
  spec.add_runtime_dependency 'tls_test_kit', '0.1.1'
  spec.add_runtime_dependency 'us_core_test_kit', '0.3.0'
