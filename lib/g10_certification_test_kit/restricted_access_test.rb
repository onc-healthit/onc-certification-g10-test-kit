module G10CertificationTestKit
  class RestrictedAccessTest < Inferno::Test
    id :g10_restricted_access_test
    input :patient_id, :expected_resources, :received_scopes
    ...
    run do
      ...
      fhir_search(resource_type, client: :restricted_access, params: search_params)

      if read_scope_expected?
