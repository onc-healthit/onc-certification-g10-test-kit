...
module ONCCertificationG10TestKit
  module BulkExportValidationTester
    ...
    # Remove us-core-observation-sexual-orientation from bulk data validation as directed by ASTP/ONC enforcement discretion issued on March 21, 2025:
    ...
    # Since (g)(10) certification test kit does not cover US Core v5, adding profile url to this list for all versions is acceptable for now.
    PROFILES_TO_SKIP = [
